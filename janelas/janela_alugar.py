...
class AlugarVeiculo(ctk.CTkToplevel):
    def __init__(self, master=None):
        ...
        self.botaoAlugar = ctk.CTkButton(self.frameItens, text='Alugar', font=('Open Sans', 16, 'bold'), comand=self.alugar_veiculo)
    ...
    def carregar_clientes(self):
        ...
        db.disconect()
        return values
    def alugar_veiculos(self)
        placa = self.comboPlaca.get()
        cpf = self.comboCliente.get().splic(' - ')[0]
